...
import { messageApplicationsDirectory } from '../../managers/directories.mjs';

import MessageApplication from '../../structures/Application/MessageApplication.mjs';
...
for (const _folderName of folderNames) {
    ...
    const filePath = path.join(messageApplicationsDirectory, _folderName, 'main.mjs');
