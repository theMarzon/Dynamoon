...
const paths = {
    ...
    applications: path.join(process.cwd(), 'applications'),

    applicationsCommands: path.join(process.cwd(), 'applications', 'commands'),
    applicationsMessages: path.join(process.cwd(), 'applications', 'messages'),
    applicationsUsers:    path.join(process.cwd(), 'applications', 'users')
};
